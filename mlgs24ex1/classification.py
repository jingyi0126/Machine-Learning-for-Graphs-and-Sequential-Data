...
def classify_review(hmm_1, hmm_5, p, sentence_in):
    ...
    ### YOUR CODE HERE ###
    one_star_loglik = hmm_1.loglik_sentence(sentence_in)
    five_star_loglik = hmm_5.loglik_sentence(sentence_in)

    p_1 = np.log(p) + one_star_loglik
    p_5 = np.log(1-p) + five_star_loglik
